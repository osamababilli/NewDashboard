...
onMounted(() => {
    // إنشاء سكربت ديناميكي لتحميل الملف
    const script = document.createElement("script");
    script.src = "./assets/js/homeOneChart.js"; // المسار الصحيح للملف
    document.body.appendChild(script);

    // التحقق عند اكتمال التحميل
    script.onload = () => {
        console.log("homeOneChart.js loaded successfully!");
        // يمكنك هنا استدعاء أي دوال من الملف
    };
});
</script>
